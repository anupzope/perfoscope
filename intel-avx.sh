...
case "$1" in
  -c|--configure)
    ...
    cmake "$BASEDIR" \
      ...
      -DCMAKE_C_FLAGS_DEBUG:STRING="-g -debug inline-debug-info -p -O0 -xAVX -qno-offload" \
      -DCMAKE_C_FLAGS_RELEASE:STRING="-O3 -DNDEBUG -ip -xAVX -qno-offload" \
      -DCMAKE_C_FLAGS_RELWITHDEBINFO="-g -debug inline-debug-info -p -O3 -ip -xAVX -qno-offload" \
      -DCMAKE_CXX_FLAGS_DEBUG:STRING="-g -debug inline-debug-info -p -O0 -xAVX -qno-offload" \
      -DCMAKE_CXX_FLAGS_RELEASE:STRING="-O3 -DNDEBUG -ip -xAVX -qno-offload" \
      -DCMAKE_CXX_FLAGS_RELWITHDEBINFO="-g -debug inline-debug-info -p -O3 -ip -xAVX -qno-offload" \
      -DCMAKE_Fortran_FLAGS_DEBUG:STRING="-g -debug inline-debug-info  -p -O0 -xAVX -qno-offload" \
      -DCMAKE_Fortran_FLAGS_RELEASE:STRING="-O3 -DNDEBUG -ip -xAVX -qno-offload" \
      -DCMAKE_Fortran_FLAGS_RELWITHDEBINFO="-g -debug inline-debug-info -p -O3 -ip -xAVX -qno-offload" \
